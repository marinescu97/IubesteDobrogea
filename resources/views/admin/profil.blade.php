            ...
            <div class="col-md-10">
                <div class="card shadow-lg rounded">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('admin.setari-profil')}}" enctype="multipart/form-data">
                            @csrf
                            @if ($errors->any())
                  ...
                  <strong>{{ $message }}</strong>
                            ...
                            <div class="row" style="padding-left: 20px;">
                                ...
                                <div class="col-sm-6" style="padding-left: 30px;">
                                    <div class="input-group">
                                        <textarea id="descriere" class="form-control @error('descriere') is-invalid @enderror" value="{{Auth::user()->descriere}}" style="width: 250px; height: 250px;" name="descriere">{{Auth::user()->descriere}}</textarea>
                                        @error('adresa')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
